 ...
 */
final class Version20240619141231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE completions CHANGE routine_activities_id challenges_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE completions CHANGE challenges_id routine_activities_id INT DEFAULT NULL');
